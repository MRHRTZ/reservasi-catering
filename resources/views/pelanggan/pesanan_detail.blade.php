    ...
    <div class="row mt-4">
        <div class="card col-lg-7 my-4">
            ...
            <div class="form-group">
                ...
                <input type="text" name="payment" value="{{ $pesanan->kode_pembayaran }}" class="form-control" readonly>
            </div>
            <div class="form-group">
                <label for="notes">Catatan Pesanan</label>
                <textarea name="notes" id="notes" class="form-control" placeholder="Catatan kosong." readonly>{{ $pesanan->catatan_pembeli }}</textarea>
            </div>
            <div class="form-group">
